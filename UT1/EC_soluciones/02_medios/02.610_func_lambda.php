...
<html lang="en">
<body>
<h1>Ejercicio 610 Funciones Lambda</h1>
<h4>Prueba de números pares e impares con 50 números aleatorios</h4>
<ul>
    <li>Números Pares: <?php dump($arrayFilter($arrAleatorios, fn($num) => $num % 2 == 0)) ?></li>
    <li>Números Impares: <?php dump($arrayFilter($arrAleatorios, fn($num) => $num % 2 != 0)) ?></li>
