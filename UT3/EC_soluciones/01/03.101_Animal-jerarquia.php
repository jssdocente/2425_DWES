...
abstract class Animal {
    ...
    public readonly int $sexo;
    public readonly HabitatEm $habitat;

    public function __construct(string $name, int $sexo, HabitatEm $habitat) {
        $this->name = $name;
        $this->sexo = $sexo;
...
abstract class Mamifero extends Animal {
    ...
    public function __construct(string $name, int $sexo, HabitatEm $habitat, int $numeroPatas, string $raza) {
...
abstract class Ave extends Animal {
    ...
    public function __construct(string $name, int $sexo, HabitatEm $habitat, string $especie, string $colorPlumaje) {
        parent::__construct($name, $sexo, $habitat);
...
final class Perro extends Mamifero implements IMascota, IClonar {
    ...
    public function __construct(string $name, int $sexo, string $raza) {
    ...
    public function clonar(): object {
        return new Perro($this->name, $this->sexo, $this->numeroPatas, $this->raza);
    }
}
...
final class Canario extends Ave implements IMascota {
    ...
    public function __construct(string $name, int $sexo, string $especie, string $colorPlumaje) {
...
//
//$gato = new Gato("Garfield", 3, 4, "Siamés");
...
//
//$pinguino = new Pinguino("Tux", 2, "Pingüino", "Blanco y Negro");
